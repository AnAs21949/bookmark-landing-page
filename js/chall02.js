...
bookmarking.addEventListener('click', function(e) {
    ...
    `<div class="figure-1">
    <div class="image">
        <img src="/images-ch02/illustration-features-tab-1.svg" alt=""></img>
        <div class="blue"></div>
    </div>
    </div>
    <div class="hero">
...
searching.addEventListener('click', function(e) {
    ...
    `<div class="figure-1">
    <div class="image">
        <img src="/images-ch02/illustration-features-tab-2.svg" alt=""></img>
        <div class="blue"></div>
    </div>
    </div>
    <div class="hero">
...
sharing.addEventListener('click', function(e) {
    ...
    `<div class="figure-1">
    <div class="image">
        <img src="/images-ch02/illustration-features-tab-3.svg" alt=""></img>
        <div class="blue"></div>
    </div>
    </div>
    <div class="hero">
